...
&lt;p&gt;Um padrão é uma cadeia de caracteres que serão substituídos pela data e hora de um calendário de acordo com o formato introduzido, ou utilizado para gerar os dados de um calendário durante o seu processamento.&lt;/p&gt;
&lt;p&gt;O símbolo Campo de data abaixo contém os caracteres utilizados nos padrões para mostrar os formatos adequados para uma configuração regional específica, tais como yyyy para o ano. Pode utilizar os caracteres tantas vezes quantas quiser. Por exemplo, se y for utilizado para o ano, &apos;yy&apos; poderá gerar &apos;99&apos; e &apos;yyyy&apos; &apos;1999&apos;. Para a maioria dos valores numéricos, o número de caracteres especifica a largura do campo. Por exemplo, se h for a hora, &apos;h&apos; poderá gerar &apos;5&apos;, mas &apos;hh&apos; gera &apos;05&apos;. Para alguns caracteres, o número de caracteres especifica que é utilizada a forma abreviada ou completa da data/hora, mas pode utilizar diversas combinações de acordo com os padrões descritos abaixo.&lt;/p&gt;
&lt;p&gt;Duas plicas seguidas representam uma plica literal, tanto dentro como fora da plica individual. O texto introduzido entre plicas não será interpretado (exceto para duas plicas adjacentes). Caso contrário, todas as letras ASCII entre a e z ou A e Z serão reservadas como caracteres de sintaxe e requerem plicas se forem para representar caracteres literais. Adicionalmente, alguns caracteres de pontuação ASCII poderão ser variáveis futuramente (exemplo &quot;:&quot; para ser interpretado como separador de hora e &apos;/&apos; como separador de data, sendo substituídos pelos respetivos caracteres da configuração regional em exibição).&lt;br /&gt;&lt;/p&gt;
&lt;table border=&quot;1&quot; width=&quot;100%&quot; cellpadding=&quot;4&quot; cellspacing=&quot;0&quot;&gt;
...
&lt;tr&gt;&lt;td&gt;ddd&lt;/td&gt;&lt;td&gt;o nome abreviado do dia (Seg a Dom).&lt;/td&gt;&lt;/tr&gt;
...
&lt;p&gt;&lt;br /&gt;&lt;b&gt;Nota:&lt;/b&gt; quaisquer caracteres do padrão que não estejam no intervalo [&apos;a&apos;..&apos;z&apos;] e [&apos;A&apos;..&apos;Z&apos;] serão tratados como texto entre aspas. Por exemplo, os caracteres &apos;:&apos;, &apos;.&apos;, &apos; &apos;, &apos;#&apos; e &apos;@&apos; aparecerão na hora resultante do padrão mesmo se não estiverem entre aspas. A plica é utilizada para fazer o &apos;escape&apos; das letras. Duas plicas seguidas numa linha, dentro ou fora de uma frase entre aspas representa uma plica &apos;real&apos;.&lt;/p&gt;&lt;/li&gt;&lt;li&gt;O intervalo mínimo de atualização é de 1 segundo. Se utilizar z ou zzz, a hora será mostrada como fração de milissegundos, mas não será atualizada nessa base (por motivos de desempenho).&lt;/li&gt;&lt;ul</translation>
    </message>
    <message>
        <source>&lt;h1&gt;Custom Date/Time Format Syntax&lt;/h1&gt;
&lt;p&gt;A date pattern is a string of characters, where specific strings of characters are replaced with date and time data from a calendar when formatting or used to generate data for a calendar when parsing.&lt;/p&gt;
